...
export class ProjectsService{
  ...
  projects : ProjectModel [] = [
    ...
    new ProjectModel(
      "My_first_implementation",
      new Date(),
      "log4j",
      "The home network or small area network enables multiple devices e.g. PCs, tablets etc to connect to each other, and also to connect to the internet. A small network design is usually simple. The number and type of devices included are significantly reduced compared to that of a larger network., which targeted computers running the Microsoft Windows operating system by encrypting data and demanding ransom payments in the Bitcoin cryptocurrency."
    ),
    new ProjectModel(
      "Network_attacks_simulation",
      new Date(),
